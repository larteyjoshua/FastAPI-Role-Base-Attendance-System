...
Revision ID: 315a24936790
Revises: 315b1bf4b7c4
Create Date: 2022-10-24 23:42:50.630468
...
revision = '315a24936790'
down_revision = '315b1bf4b7c4'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_attendance_userId'), 'attendance', ['userId'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_attendance_userId'), table_name='attendance')
